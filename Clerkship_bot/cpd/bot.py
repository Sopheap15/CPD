...
def main() -> None:
    ...
    try:
        # Short, fast getUpdates polls with a much longer client read
        # timeout. Every poll completes cleanly and no client-side abort
        # can leave a half-open connection that a retry would then clash
        # with (Telegram rejects the older of two active polls with 409
        # "Conflict: terminated by other getUpdates request").
        app.run_polling(timeout=5, bootstrap_retries=10)
